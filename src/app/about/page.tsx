  ...
  return (
    ...
    <div className='grid grid-cols-3 p-4 gap-6 min-h-fit'>
      ...
      <div className="text-center bg-white/10 backdrop-blur-lg rounded-xl shadow-2xl border border-white/20">
        <h2 className='text-center text-2xl font-bold text-orange-500 mb-4'>Brief Bio</h2>
      ...
      {/* Core Skills */}
      <div className='text-center bg-white/10 backdrop-blur-lg rounded-xl shadow-2xl border border-white/20'>
        <h2 className='text-2xl font-bold text-orange-500 mb-4'>Core Skills</h2>
    ...
    {/* {Key Values} */}
      <div className='text-center bg-white/10 backdrop-blur-lg rounded-xl shadow-2xl border border-white/20'>
        <h2 className='text-2xl font-bold text-orange-500 mb-4'>Key Values</h2>
          <ul className="text-justify text-white px-4 py-4 list-disc pl-6">
